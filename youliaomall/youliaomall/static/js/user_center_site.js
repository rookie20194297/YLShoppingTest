var vm = new Vue({
    ...
    methods: {
        ...
        save_address(){
            ...
            if (this.error_receiver || this.error_place || this.error_mobile || this.error_email || !this.form_address.province_id || !this.form_address.city_id || !this.form_address.district_id) {
                ...
                if (this.editing_address_index === '') {
                    // 新增地址
                    var url = this.host + '/create_addresses/';
                    ...
                    // 修改地址
                    var url = this.host + '/update_addresses/' + this.addresses[this.editing_address_index].id + '/';
        ...
        delete_address(index){
            var url = this.host + '/update_addresses/' + this.addresses[index].id + '/';
            axios.delete(url, {
                headers: {
                    'X-CSRFToken': getCookie('csrftoken')
                },
